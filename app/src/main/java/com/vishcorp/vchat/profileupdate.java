...
public class profileupdate extends AppCompatActivity {
    ...
    private ImageButton btnbackuppro;


    private FirebaseStorage firebaseStorage;


    ProgressBar probaruppro;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarofupdateprofile=findViewById(R.id.toolbarupprofile);
        btnbackuppro=findViewById(R.id.upprobackbtn);
        newuserimg=findViewById(R.id.getuserimageforuppro);
        probaruppro=findViewById(R.id.probaruppro);
        newusername=findViewById(R.id.usernameproactivity);
        updateprofilebutton=findViewById(R.id.btnuppro);
        ...
        btnbackuppro.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        updateprofilebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    probaruppro.setVisibility(View.VISIBLE);
                    ...
                    probaruppro.setVisibility(View.INVISIBLE);
                    Intent intent=new Intent(profileupdate.this,chatspace.class);
        ...
        newuserimg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        storageReference.child("Images").child(firebaseAuth.getUid()).child("Profile Pic").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                Picasso.get().load(uri).into(newuserimg);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==PICK_IMAGE && resultCode==RESULT_OK)
        {
            ...
            newuserimg.setImageURI(imagepath);
        }
