...
public class MessagesAdapter extends RecyclerView.Adapter {
    ...
    public MessagesAdapter(Context context, ArrayList<messagesenderandreciver> messagesArrayList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        messagesenderandreciver messages=messagesArrayList.get(position);
